...
TERMUX_PKG_SRCURL=https://github.91chi.fun/https://github.com/xiph/rav1e/archive/refs/tags/v${TERMUX_PKG_VERSION}.tar.gz
...
termux_step_make_install(){
	...
	termux_download \
		https://github.91chi.fun/https://github.com/lu-zero/cargo-c/releases/download/v0.9.5/cargo-c-linux.tar.gz \
